...
This quality control leaves us with `r nrow(preci_data)` *Calluna vulgaris* records. A significant drop in data points which may well change our analyses and their outcomes drastically.
...
ggplot(data = NO_municip) +
  geom_sf(fill = "white") +
  geom_point(data = data_subset@data, size = 1,
